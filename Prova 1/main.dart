...
class StateB extends State<TelaB> {
  ...
  void _enviar() async {
    ...
    // Define a URL
    String url = 'http://demo9001831.mockable.io/login';
...
class StateC extends State<TelaC> {
  ...
  void _menor60() {
    setState(() {
      data = dataList.where((element) => element['nota'] < 60).toList();
    });
  }
  ...
  void _100() {
    setState(() {
      data = dataList.where((element) => element['nota'] == 100).toList();
    });
  }
          ...
          children: [
            Expanded(
              child: ListView.builder(
                itemCount: data
                    .length, // Use 'data.length' instead of 'dataList.length'.
                itemBuilder: (BuildContext context, int index) {
                  final item = data[index]; // Access the correct 'data' item.
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      color: item['nota'] < 60
                          ...
                          : item['nota'] >= 60 && item['nota'] < 100
                              ...
                              : const Color.fromARGB(255, 25, 221, 7),
